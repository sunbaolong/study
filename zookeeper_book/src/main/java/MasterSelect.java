...
public class MasterSelect implements Watcher {
    ...
    void getLock(String path, String data, CreateMode createMode) throws IOException, KeeperException,
        ...
        if (zk == null) {
            zk = this.createSession("192.168.73.101:2181,192.168.73.102:2181,192.168.73.103:2181", 2000, this);
        }
    ...
    void exists(String path) throws KeeperException, InterruptedException, IOException {
        ...
        if (zk == null) {
            zk = this.createSession("192.168.73.101:2181,192.168.73.102:2181,192.168.73.103:2181", 5000, this);
        }
        zk.exists(path, true);
    }
